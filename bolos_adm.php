...
<title>Bolos administrador</title>
</head>
...
<div id="centro">
<img src="imagens/botao_grande_bolos.png" width="583" height="50" title="sucos" alt="sucos"/>
...
<?php
	...
	$resultado=mysql_query("SELECT * FROM cardapio WHERE tipo ='bolos' ORDER BY cod_produto DESC LIMIT 30 ");
...
for($i=0;$i<$linhas;$i++){
	$reg=mysql_fetch_array($resultado);
			...
			<td>
			<table>
			<form action='atualiza_bolos.php' method='post'>	
			<tr>
			...
			<tr>	
		 	...
		 	<tr>
				<td><input type='submit' value='Salvar'/></td>
		 		...
		 		<td><form action='deletar_bolos.php' method='post' ENCTYPE='multipart/form-data'>
