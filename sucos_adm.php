...
<title>Sucos Administrador</title>
</head>
...
<div id="centro">
<img src="imagens/botao_grande_sucos.png" width="583" height="50" title="sucos" alt="sucos"/>
...
for($i=0;$i<$linhas;$i++){
	$reg=mysql_fetch_array($resultado);
			...
			<tr>
			<td>
			<form action='atualiza_sucos.php' method='post' ENCTYPE='multipart/form-data'>	
			...
			<tr>	
		 	...
		 	<tr>
				<td><input type='submit' value='Salvar'/></td>
		 		...
		 		<td><form action='deletar_sucos.php' method='post' ENCTYPE='multipart/form-data'>
