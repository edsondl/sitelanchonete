...
<title>Lanches adiministrador</title>
</head>
...
<div id="centro">
<img src="imagens/botao_grande_lanches.png" width="583" height="50" title="sucos" alt="sucos"/>
...
<?php
	...
	$resultado=mysql_query("SELECT * FROM cardapio WHERE tipo ='lanches' ORDER BY cod_produto DESC LIMIT 30 ");
...
for($i=0;$i<$linhas;$i++){
	$reg=mysql_fetch_array($resultado);
			...
			<td>
			<table>
			<form action='atualiza_lanches.php' method='post'>	
			<tr>
			...
			<tr>	
		 	...
		 	<tr>
				<td><input type='submit' value='Salvar'/></td>
		 		...
		 		<td><form action='deletar_lanches.php' method='post' ENCTYPE='multipart/form-data'>
