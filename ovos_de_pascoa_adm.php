...
<title>Ovos de Páscoa Adiministrador</title>
</head>
...
<div id="centro">
<img src="imagens/ovos_de_pascoa_grande.png" width="583" height="50" title="sucos" alt="sucos"/>
...
<?php
	...
	$resultado=mysql_query("SELECT * FROM cardapio WHERE tipo ='ovos' ORDER BY cod_produto DESC LIMIT 30 ");
...
for($i=0;$i<$linhas;$i++){
	$reg=mysql_fetch_array($resultado);
			...
			<td>
			<table>
			<form action='atualiza_ovos.php' method='post'>	
			<tr>
				<td><input type='hidden' value='$reg[0]' name='codigo'/></td>
			</tr>
				<tr><td><font color='black'>Nome:</font></td>
			...
			<tr>	
		 	...
		 	<tr>
		 		...
		 		<td><form action='deletar_ovos.php' method='post' ENCTYPE='multipart/form-data'>
